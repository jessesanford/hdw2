...
```
> **Note:** This script is now named `hdw2.sh`; older instructions may reference `bypass-mdm.sh`. This fork preserves the original author credit in the script header.
