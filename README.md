...
```
> **Note:** This script is now named `hdw2.sh`; older instructions may reference `bypass-mdm.sh`. If you're using a fork, update the URL to your repository. This fork preserves the original author credit in the script header.
